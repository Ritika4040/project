...
export default function Events() {
  ...
  const eventImages = [
    { title: "School Event 1", src: "/d.jpeg" },
    { title: "School Event 2", src: "/e.jpeg" },
    { title: "School Event 3", src: "/k.jpeg" },
    { title: "School Event 4", src: "/m.jpeg" },
    { title: "School Event 5", src: "/q.jpeg" },
    { title: "School Event 6", src: "/p.jpeg" },
  ]
      ...
      <section className="py-16 md:py-24 bg-muted">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-center mb-10">
            A glimpse of memorable moments from various school events and celebrations.
          </p>
