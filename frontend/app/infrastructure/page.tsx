          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={gallery.title} className="relative group overflow-hidden rounded-lg h-64">
                <img
                  src={
                    gallery.title === "Main Building"
                      ? "/school_image.jpeg"
                      : gallery.title === "Science Lab"
                      ? "/chem.jpeg"
                      : gallery.title === "Library"
                      ? "/lia.jpg"
                      : `/.jpg?height=300&width=400&query=${gallery.query}`
                  }
                  alt={gallery.title}
                  className="w-full h-full object-cover group-hover:scale-105 transition duration-300"
                  style={gallery.title === "Science Lab" ? { transform: "rotate(270deg)" } : undefined}
                />
